<template lang="html">
  <el-card class="box-card">
    <div class="search-bar">
      <el-form :inline="true" :model="searchData" class="fl">
        ...
        <el-form-item label="班课ID：">
          <el-input v-model="searchData.roleName" placeholder="请输入班课ID" @keyup.enter.native="onSearch()"></el-input>
        </el-form-item>
      </el-form>
      <div class="fl">
      ...
      <el-button type="success" icon="el-icon-plus" style="margin:0px 0px 0px 30px" @click="handleReset">新增班课</el-button>
    </div>
    <el-table
    ...
    <!-- <div class="fl">
        <el-row >
            <el-col :span="12">
            <el-button type="success" icon="el-icon-plus" @click="handleReset">新增班课</el-button>
            </el-col>
            <el-col :span="4">班课ID:
            </el-col>
            <el-col :span="8">
            <el-input placeholder="请输入内容"v-model="input4" ></el-input>
            </el-col>
        </el-row>      
    </div> -->
    ...
    <div  class="tools-bar">
      <el-button  type="success" icon="el-icon-plus" size="small" @click="dialogFormVisible = true;">选中删除</el-button>
    </div> -->
