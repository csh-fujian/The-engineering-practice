<template lang="html">
  <el-card class="box-card">
    ...
    <div class="fl">
        <el-button type="success" icon="el-icon-plus" @click="handleReset">新增角色</el-button>
        <el-button type="text" @click="onSearch">选中删除</el-button>
    </div>
    <!-- <div  class="tools-bar">
    ...
    <div>
      <el-table
        ...
        <el-table-column label="选中" prop="status" min-width="60">
